...
//
//	newNode = createNewNode(2, "May", "6/3/2018", "NA", 18.00, "may@gmail.com", "0184628592", "13A, Jalan Barat, Taman Mutiara, 57000 Chearas, Kuala Lumpur.", "CRS1001", "eXcel Tuition Center (Cheras)", "AM2280", "Additional Mathematics", 4.8);
//	addTutorProcess(newNode);
//
//	newNode = createNewNode(3, "Brian", "3/8/2019", "NA", 17.00, "brian@gmail.com", "0118427585", "23-B, Jalan Jalil, 57000 Bukit Jalil, Kuala Lumpur.", "BKJ1001", "eXcel Tuition Center (Bukit Jalil)", "MAT3125", "Mathematics", 4.6);
//	addTutorProcess(newNode);
//
//	displayTutor();
//
...
//			if (status == 0)
//			{
//				cout << endl << "Incorrect username and/or password. 1- Try Again, Others- No (Exit): ";
//				cin >> userInput;
//			}
//		}
//	}
...
//	int status = login();
//
//	// menu goes here, can use switch case
//	
